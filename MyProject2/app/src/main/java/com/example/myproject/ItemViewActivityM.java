...
public class ItemViewActivityM extends AppCompatActivity
{
    ImageView imageView;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_item_view_m);
        ...
        ratingBar.setOnRatingBarChangeListener(new RatingBar.OnRatingBarChangeListener()
        {
            ...
            public void onRatingChanged(RatingBar ratingBar, float rating, boolean fromUser)
            {
                ...
                Toast.makeText(ItemViewActivityM.this,"Thank you for rating",Toast.LENGTH_LONG).show();
            }
        });
        ...
        addToCart.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                ...
                {
                    Toast.makeText(ItemViewActivityM.this, "Item is out of stock", Toast.LENGTH_LONG).show();
                }
                else
                {
                    Toast.makeText(ItemViewActivityM.this,"Item is in stock",Toast.LENGTH_LONG).show();
                    addToCart();
                }
            }
        });
    ...
    public void add()
    {
        ...
        if(isInserted == true)
            Toast.makeText(ItemViewActivityM.this,"Data Inserted",Toast.LENGTH_LONG).show();//if the data was inserted
        else
            Toast.makeText(ItemViewActivityM.this,"Data not Inserted",Toast.LENGTH_LONG).show();//if the data was not inserted
    }
    //a function that adds the item to the cart and puts it in a intent and moves to MyCart activity
    public void addToCart()
    {
        startActivity(new Intent(ItemViewActivityM.this,MyCart.class).putExtra("item",i));
        Toast.makeText(ItemViewActivityM.this,"Item added to cart",Toast.LENGTH_LONG).show();//if the data was inserted
    }
}

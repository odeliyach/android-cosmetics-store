...
public class AccountDb
{
    ...
    // create some constants for the table and fields
    ...
    private final static String FORMAT = "CREATE TABLE %s (%s INTEGER PRIMARY KEY AUTOINCREMENT," + "%s TEXT,%s TEXT )";
    ...
    public AccountDb(Context context) { openHelper = new DBHelper(context, DB_NAME, null, DB_VERSION); }

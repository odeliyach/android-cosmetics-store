...
public class ItemViewActivityHair extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_item_view_hair);
        ...
        ratingBar.setOnRatingBarChangeListener(new RatingBar.OnRatingBarChangeListener()
        {
            ...
            public void onRatingChanged(RatingBar ratingBar, float rating, boolean fromUser)
            {
                ...
                save(rating);
                Toast.makeText(ItemViewActivityHair.this,"Thank you for rating",Toast.LENGTH_LONG).show();
            }
        });
        ...
        addToCart.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                startActivity(new Intent(ItemViewActivityHair.this,MyCart.class).putExtra("item",i));
            }
        });
    ...
    public void add()//  a function that calls the function isInserted that inserts the data and is in DatabaseHelper class
    {
        ...
        if(isInserted == true)
            Toast.makeText(ItemViewActivityHair.this,"Data Inserted",Toast.LENGTH_LONG).show();//if the data was inserted
        else
            Toast.makeText(ItemViewActivityHair.this,"Data not Inserted",Toast.LENGTH_LONG).show();//if the data was not inserted
    }
    ...
    {
        startActivity(new Intent(ItemViewActivityHair.this,MyCart.class).putExtra("item",i));
        Toast.makeText(ItemViewActivityHair.this,"Item added to cart",Toast.LENGTH_LONG).show();//if the data was inserted
    }

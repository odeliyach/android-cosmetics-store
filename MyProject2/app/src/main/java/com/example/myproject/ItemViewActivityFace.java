...
public class ItemViewActivityFace extends AppCompatActivity
{
    ImageView imageView;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_item_view_face);
        ...
        ratingBar.setOnRatingBarChangeListener(new RatingBar.OnRatingBarChangeListener()
        {
            ...
            public void onRatingChanged(RatingBar ratingBar, float rating, boolean fromUser)
            {
                ...
                save(rating);
                Toast.makeText(ItemViewActivityFace.this,"Thank you for rating",Toast.LENGTH_LONG).show();
            }
        });
        ...
        addToCart.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                startActivity(new Intent(ItemViewActivityFace.this,MyCart.class).putExtra("item",i));
            }
        });
    ...
    public void add()
    {
        ...
        if(isInserted == true)
            Toast.makeText(ItemViewActivityFace.this,"Data Inserted",Toast.LENGTH_LONG).show();//if the data was inserted
        else
            Toast.makeText(ItemViewActivityFace.this,"Data not Inserted",Toast.LENGTH_LONG).show();//if the data was not inserted
    }

    public void addToCart()//a function that calls the function isInserted that inserts the data and is in DatabaseHelper class
    {
        startActivity(new Intent(ItemViewActivityFace.this,MyCart.class).putExtra("item",i));
        Toast.makeText(ItemViewActivityFace.this,"Item added to cart",Toast.LENGTH_LONG).show();//if the data was inserted
    }

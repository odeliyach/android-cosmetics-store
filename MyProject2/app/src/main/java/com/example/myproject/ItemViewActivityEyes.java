...
public class ItemViewActivityEyes extends AppCompatActivity
{
    ImageView imageView;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_item_view_eyes);
        ...
        ratingBar.setOnRatingBarChangeListener(new RatingBar.OnRatingBarChangeListener()
        {
            ...
            public void onRatingChanged(RatingBar ratingBar, float rating, boolean fromUser)
            {
                ...
                save(rating);
                Toast.makeText(ItemViewActivityEyes.this,"Thank you for rating",Toast.LENGTH_LONG).show();
            }
        });
    ...
    public void add()
    {
        ...
        if(isInserted == true)
            Toast.makeText(ItemViewActivityEyes.this,"Data Inserted",Toast.LENGTH_LONG).show();//if the data was inserted
        else
            Toast.makeText(ItemViewActivityEyes.this,"Data not Inserted",Toast.LENGTH_LONG).show();//if the data was not inserted
    }

    public void addToCart()//a function that calls the function isInserted that inserts the data and is in DatabaseHelper class
    {
        startActivity(new Intent(ItemViewActivityEyes.this,MyCart.class).putExtra("item",i));
        Toast.makeText(ItemViewActivityEyes.this,"Item added to cart",Toast.LENGTH_LONG).show();//if the data was inserted
    }
